...
It is an abstract type for all text vectorizers and transmformer.
"""
abstract type BaseTextExtractor <: Transformer end
...
# _of_words(text_data::Vector{String}, vocabulary::Vector{String})
